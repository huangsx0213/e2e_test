...
import { PipelineRunState } from './pipeline-run-state.ts';
import { SqliteRunPersister, type RunPersister } from './pipeline-persister.ts';
...
export class PipelineExecutionScope {
  private readonly state = new PipelineRunState();
  ...
  constructor(
    ...
    private readonly persister: RunPersister = new SqliteRunPersister(),
  ) {}
