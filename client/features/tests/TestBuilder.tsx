...
import { TestSuite, TestCase, TestStep, Project, ActionType, SuiteVariable, HeaderProfile, BodyTemplate, ApiEndpoint } from '@/shared/types';
                    ...
                    <div className="space-y-0.5">
                        {filteredSuites.map(suite => (
                            <div key={suite.id} className="select-none">
                                <div
                                    className={`group px-2 py-1.5 rounded-md text-sm font-medium cursor-pointer flex items-center justify-between transition-all duration-200 ${activeSuiteId === suite.id && !activeCaseId
