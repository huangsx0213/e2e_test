                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    {report.status === "COMPLETED" ? (
                      ...
                      <Loader2
                        size={16}
                        className="text-blue-500 animate-spin shrink-0 mt-0.5"
                      />
                    )}
                  </div>
          ...
          {selectedReport ? (
                ...
                <div className="flex items-start justify-between mb-8">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div
                        className={`px-3 py-1 rounded-full border flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider ${
                    ...
                    <div className="flex items-center gap-6 text-sm text-slate-500 mt-4">
                      ...
                      <div className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-md border border-slate-100">
                        ...
                        <span className="font-medium text-slate-700">
                          {selectedReport.environment || "DEV"}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-end">
                    <div
                      ...
                      style={{
                        color:
                          selectedReport.passRate === 100
                            ? "#10b981"
                            : selectedReport.passRate >= 50
                              ? "#f59e0b"
                              : "#ef4444",
                      }}
                    >
                    ...
                    <span className="text-sm font-semibold text-slate-400 uppercase tracking-widest mt-1">
                      Pass Rate
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-white border border-emerald-100 rounded-xl p-5 flex items-center gap-4 shadow-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <p className="text-emerald-600/80 text-xs font-bold uppercase tracking-wider mb-0.5">
                        Passed
                      </p>
                      <p className="text-2xl font-black text-emerald-700">
                        {selectedReport.passedCases || 0}
                      </p>
                    </div>
                  </div>
                  <div className="bg-white border border-red-100 rounded-xl p-5 flex items-center gap-4 shadow-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <p className="text-red-600/80 text-xs font-bold uppercase tracking-wider mb-0.5">
                        Failed
                      </p>
                      <p className="text-2xl font-black text-red-700">
                        {selectedReport.failedCases || 0}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-slate-400 bg-slate-50">
              ...
              <p className="text-slate-500">
                Choose an execution report from the sidebar to view its details.
              </p>
            </div>
          )}
        </div>
