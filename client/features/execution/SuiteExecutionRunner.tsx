...
import { TestSuite, ExecutionLog, Project, HeaderProfile, BodyTemplate, ApiEndpoint, ExecutionReport } from '@/shared/types';
...
export const SuiteExecutionRunner: React.FC<SuiteExecutionRunnerProps> = ({ suite, project, headers, bodies, endpoints, environments, initialEnvironment, onClose, reportsApi }) => {
            ...
            <div className="h-16 px-6 bg-slate-900 border-b border-slate-800 flex justify-between items-center text-white shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-medium">{suite.cases.length} Cases</p>
                        </div>
                    </div>
