...
import { TestGenNodeDetail } from '../TestGenNodeDetail';

describe('TestGenNodeDetail', () => {
  afterEach(cleanup);
  ...
  it('TC-3.1: shows placeholder when no node selected', () => {
    render(React.createElement(TestGenNodeDetail, defaultProps));
  ...
  it('TC-3.2: agent node shows 6 tabs', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: agentNode }));
  ...
  it('TC-3.3: thinking tab shows content when provided', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: agentNode, thinkingText: 'Analyzing requirements...' }));
  ...
  it('TC-3.4: input tab shows system prompt and user message', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: agentNode, agentLog }));
  ...
  it('TC-3.8: checkpoint shows conditions list', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: cpNode, checkpointData }));
  ...
  it('TC-3.11: auto-passed message for checkpoint in auto mode', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: cpNode }));
  ...
  it('TC-3.9: approve button triggers onCheckpointAction', () => {
    ...
    render(React.createElement(TestGenNodeDetail, { ...defaultProps, node: cpNode, checkpointData, onCheckpointAction }));
