...
import { Project, TestModule, TestStep, ActionType, ModuleParameter, HeaderProfile, BodyTemplate, ApiEndpoint } from '@/shared/types';
                    ...
                    <div className="flex flex-col min-h-full">
                        ...
                        <div className="px-6 pb-6 pt-6 flex-1 space-y-3 bg-gray-50">
                             ...
                             <StepList
                                 ...
                                 variables={(activeModule.params || []).map(p => ({ id: p.id, key: p.name, value: p.defaultValue }))}
                                 endpoints={endpoints}
                                 headers={headers}
                                 bodies={bodies}
                             />
