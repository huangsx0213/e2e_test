...
describe('PipelineRunHistory', () => {
  ...
  it('TC-5.1: renders list of pipeline runs', () => {
    const runs = [makeRun()];
    render(React.createElement(PipelineRunHistory, { ...defaultProps, runs }));
  ...
  it('TC-5.5: confirming delete calls onDeleteRun', async () => {
    ...
    render(React.createElement(PipelineRunHistory, { ...defaultProps, runs, onDeleteRun }));
  ...
  it('TC-5.6: empty state when no runs match filter', () => {
    render(React.createElement(PipelineRunHistory, defaultProps));
  ...
  it('clicking run name triggers onSelect', () => {
    ...
    render(React.createElement(PipelineRunHistory, { ...defaultProps, runs, onSelect }));
